...
class ScannerAgent(Agent):
    ...
    def fetch_deals(self, memory) -> List[ScrapedDeal]:
        ...
        urls = [opp.deal.url for opp in memory]  # he function uses a memory object, which is a list of previously visited URLs, to filter out any results that have already been processed. This ensures that only new, unseen deals are fetched, avoiding duplication and improving the relevance of the search results
